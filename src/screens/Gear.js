...
static navigationOptions = {title: 'Street Medic Gear'};
wrongMedicalGear = [{
    title: 'Inappropriate Gear',
    content: [
  ...
  basicMedicalGear = [{
      title: 'Basic Medical Kit - A Suggested List',
      content: [
    ...
    render() {
         return (
            <View style={styles.GearContainer}>
              <Text>Street medics beginning to use the skills in this booklet frequently begin by packing their kit in ways that are not very useful.</Text>
              <CollapsibleUnorderedList sections={this.wrongMedicalGear} />
              <CollapsibleUnorderedList sections={this.basicMedicalGear} />
              <CollapsibleUnorderedList sections={this.coldWeather} />
              <CollapsibleUnorderedList sections={this.acquiringSupplies} />
            </View>
        );
    }
 }
